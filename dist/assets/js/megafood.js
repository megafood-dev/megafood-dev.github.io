...
MF.accordion = {
    createAccordion: function createAccordion(container, title, content) {
        //on load, show/hide
        ...
        title.on('click.accordionTitle', function (e) {
            var thisContainer = $(this).closest(container);
            var thisContent = thisContainer.find(content);
    ...
    openAccordion: function openAccordion(container, title, content) {
        container.addClass('open');
        title.attr('aria-expanded', true);
        content.show();
    },

    closeAccordion: function closeAccordion(container, title, content) {
        container.removeClass('open');
        title.attr('aria-expanded', false);
        content.hide();
    },

    removeAccordion: function removeAccordion(container, title, content) {
...
MF.helpers = {
    scrollTo: function scrollTo(target, topPadding) {
    ...
    widthChanges: function widthChanges() {
        //do things only when resize width
        MF.sideNav.init();
    },
...
window.jQuery = _jquery2.default; //Libs
...
var accordion = require('./global/accordion');

var sideNav = require('./../../patterns/01-components/side-nav/_side-nav');
var productSlider = require('./../../patterns/01-components/product-slider/_product-slider');
var productRecommendations = require('./../../patterns/01-components/product-recommendations/_product-recommendations');
var imgBanner = require('./../../patterns/01-components/img-banner/_img-banner');
var videoBannerYoutube = require('./../../patterns/01-components/video-banner/_video-banner');
...
},{"./../../patterns/01-components/img-banner/_img-banner":8,"./../../patterns/01-components/product-recommendations/_product-recommendations":9,"./../../patterns/01-components/product-slider/_product-slider":10,"./../../patterns/01-components/side-nav/_side-nav":11,"./../../patterns/01-components/video-banner/_video-banner":12,"./global/accordion":5,"./global/helpers":6,"jquery":1,"picturefill/dist/picturefill.min":2,"track-focus":4}],8:[function(require,module,exports){
'use strict';

MF.imgBanner = {
    init: function init() {
        var imgBannerLink = $('.img-banner a');
        var haveImgBannerLink = imgBannerLink.length;
...
MF.productRecommendations = {
    init: function init() {
        var recProducts = $('.product-recommendations .slider');
        var haveRecProducts = recProducts.length;
...
},{"slick-carousel-browserify":3}],10:[function(require,module,exports){
'use strict';
...
MF.productSlider = {
    init: function init() {
        var haveProductSlider = $('.product-slider').length;
...
},{"slick-carousel-browserify":3}],11:[function(require,module,exports){
'use strict';
...
MF.sideNav = {
    init: function init() {
        $('.side-nav').each(function () {
            ...
            var thisTitle = thisAccordion.find('.side-nav-btn');
            var thisContent = thisAccordion.find('nav');

            if (matchMedia('(min-width: 57.563em)').matches) {
                //L+
